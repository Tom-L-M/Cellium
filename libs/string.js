...
/**
 * Compares two strings in 'sparce' mode. Using the wildcards '*' and '?' to match strings. 
 * Use '*' for any number of any character, and '?' for (one) any character.
 * 
 * @since 1.2.7 
 * 
 * @param  {String} string1 The first string to compare
 * @param  {String} string2 The second string to compare
 * @return {Boolean} If the strings are sparcely equal or not
 * @example <caption> Comparing simple strings: </caption>
 * isSparceEqual("hello", "hello")
 * // => true
 * isSparceEqual("hello", "wello")
 * // => false
 * @example <caption> Comparing complex strings: </caption>
 * isSparceEqual("?ello", "hello")
 * // => true
 * isSparceEqual("h*", "hello")
 * // => true
 * isSparceEqual("h*", "wello")
 * // => false
*/
